...
| `port` | `Optional[int]` | `None` | Host port for Playwright Server (auto-maps to guest port 3000) |
| `cdp_port` | `Optional[int]` | `None` | Host port for CDP/Puppeteer (auto-maps to guest port 9222) |
