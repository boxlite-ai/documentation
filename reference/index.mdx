...
|-----|---------|-------------|
| **Python** | 0.5.11 (stable) | Async/sync API, box types, metrics |
| **Node.js** | 0.2.8 | TypeScript definitions, box types, CDP endpoints |
| **Rust** | Native | Core runtime, stream APIs, security options |
| **C** | 0.5.11 | FFI bindings, JSON API, callback streaming |
