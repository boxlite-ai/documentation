...
|-----|---------|-------------|
| **Python** | 0.5.10 (stable) | Async/sync API, box types, metrics |
| **Node.js** | 0.2.7 | TypeScript definitions, box types, CDP endpoints |
| **Rust** | Native | Core runtime, stream APIs, security options |
| **C** | 0.2.0 | FFI bindings, JSON API, callback streaming |
