...
description: "Understand BoxLite's embedded virtual machine runtime architecture, core design philosophy, and system layers."
icon: "building"
---
...
- **Embedded library model** -- no daemon or external service required, just link and use
