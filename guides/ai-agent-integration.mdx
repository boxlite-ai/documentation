...
This guide covers best practices for integrating BoxLite as a sandboxed execution environment for AI agents. It builds on the quick-start patterns in the [Guides](/guides/index) with deeper coverage of configuration, concurrency, timeouts, security, and file transfer.
...
- [SDK Reference](/reference/index) -- Full API reference for all SDKs
