...
| Control a full desktop | [**ComputerBox**](/getting-started/core-concepts#box-types) | [SDK Reference](/reference/python/box-types#computerbox) |
| Run an interactive shell session | [**InteractiveBox**](/getting-started/core-concepts#box-types) | [SDK Reference](/reference/python/box-types#interactivebox) |
