...
<Tabs>
  ...
  <Tab title="Vercel AI SDK">
    ```bash
    npm install @boxlite-ai/boxlite ai @ai-sdk/openai zod
    ```
    ...
    async def run_agent(question: str):
        ...
        async with boxlite.CodeBox(memory_mib=1024) as codebox:
            ...
            while True:
                ...
                # Collect assistant response and any tool uses
...
<Tip>
  The Vercel AI SDK supports [many model providers](https://sdk.vercel.ai/providers) — swap `openai('gpt-4o')` for `anthropic('claude-sonnet-4-5-20250514')`, `google('gemini-2.0-flash')`, or any other supported model. The tool definitions stay the same.
</Tip>
