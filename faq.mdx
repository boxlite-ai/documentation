...
<AccordionGroup>
  ...
  <Accordion title="What's the difference between BoxLite and Docker?">
    ...
    | **Statefulness** | Stateful — retains state across stop/restart | Stateful (volumes) |
