...
<AccordionGroup>
  ...
  <Accordion title="Is BoxLite production-ready?">
    ...
    **Production considerations:**
    ...
    See [Deployment Patterns](/guides/index#deployment-patterns) for the production checklist.
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="How do I debug BoxLite issues?">
    ...
    **4. Check hypervisor:**
    ...
    See the [Debugging Guide](/guides/index#debugging) for comprehensive troubleshooting.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="How do I expose ports from a box?">
    ...
    **Access from host:**
    ...
    See [Configuring Networking](/guides/index#configuring-networking) for details.
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Where can I get help?">
    **Documentation:**
    - [Getting Started](/getting-started/index) -- Quick onboarding
  ...
  <Accordion title="How do I request a feature?">
    1. **Check roadmap:** Review [GitHub Issues](https://github.com/boxlite-labs/boxlite/issues) with the `enhancement` label
