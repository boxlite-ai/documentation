...
<CardGroup cols={2}>
  <Card title="Python SDK Reference" icon="book" href="/reference/python/index">
    Complete API reference covering Core API (Boxlite, BoxOptions, Box, Execution), Higher-level APIs (SimpleBox, CodeBox, BrowserBox, ComputerBox), API Patterns (async/await, context managers, streaming I/O), and Configuration Reference (resources, volumes, ports).
  </Card>
</CardGroup>
