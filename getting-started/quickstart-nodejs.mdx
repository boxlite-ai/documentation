...
<CardGroup cols={2}>
  <Card title="Node.js SDK Reference" icon="book" href="/reference/nodejs/index">
    Complete API reference covering Core API (SimpleBox, CodeBox, BrowserBox, ComputerBox, InteractiveBox), TypeScript support and type definitions, Async disposal patterns (TypeScript 5.2+), and Error handling (ExecError, TimeoutError).
  </Card>
</CardGroup>
