...
description: "Choose the right path to get up and running — BoxRun for a ready-to-use platform, or BoxLite SDKs for embedding sandboxing in your application."
icon: "rocket"
---
...
<CardGroup cols={2}>
  <Card title="BoxRun — Platform" icon="server" href="/boxrun/index">
    **Fastest way to start.** Install a single binary and get a CLI, REST API, web dashboard, and Python SDK. No code required to try it out.
  ...
  <Card title="BoxLite — Library" icon="cube" href="/getting-started/quickstart-python">
    **Embed in your app.** Import the library, create a sandbox, and run code — all in-process. SDKs for Python, Node.js, Rust, and C.
