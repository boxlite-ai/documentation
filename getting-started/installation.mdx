...
| Windows | x86_64 | Supported via WSL2 | Configure KVM inside WSL2 per the Linux requirements |
...
| Rust | 1.88 or newer (`Cargo.toml` `rust-version`) | Build from source (crate name `boxlite`) |
